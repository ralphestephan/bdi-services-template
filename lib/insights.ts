...
export const insights: Insight[] = [
  ...
  // 4. FINANCIAL ANALYSIS & BUSINESS PLANS  
  {
    ...
    date: "2024-12-28",
    readMins: 13,
    tags: ["Analytics", "Business Planning"],
  ...
  // 6. BUSINESS INTELLIGENCE IMPLEMENTATION
  {
    ...
    date: "2024-12-15",
    readMins: 12,
    tags: ["Business Intelligence", "BI Tools"],
    cover: "/BI.jpg",
  ...
  // 8. BI TOOLS COMPARISON
  {
    ...
    date: "2025-10-18",
    readMins: 16,
    tags: ["BI Tools", "Platform Comparison"],
  ...
  // 9. EXCEL TO BI TRANSFORMATION
  {
    ...
    date: "2025-10-16",
    readMins: 13,
    tags: ["Dashboard Migration", "Analytics"],
    cover: "/excel.png",
  ...
  // 14. IT SYSTEM INTEGRATION
  {
    ...
    date: "2025-10-06",
    readMins: 15,
    tags: ["Systems Integration", "Enterprise Architecture"],
    cover: "/api.jpg",
