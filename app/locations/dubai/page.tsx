            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                  ...
                  <span className="text-white/90 text-sm font-medium">Dubai Office</span>
                </div>
                
                <h1 className="text-4xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                  Business Intelligence
                  <span className="block" style={{ color: BRAND }}>Solutions in Dubai</span>
                </h1>
                
                <p className="text-xl text-white/80 mb-8 leading-relaxed">
                  Transform your UAE business with cutting-edge BI solutions, AI analytics, 
                  and digital transformation services in the heart of the Middle East.
                </p>
              ...
              <div className="lg:pl-8">
                <Image
                  src="/digitalcons.jpg"
                  alt="Business Intelligence Solutions Dubai"
                  width={600}
                  height={400}
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                Our Services in <span style={{ color: BRAND }}>Dubai</span>
              </h2>
              ...
              {[
                {
                  ...
                  description: "Strategic BI implementation and optimization for UAE enterprises"
                },
                {
                  icon: Zap,
              ...
              <div>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    "Comprehensive UAE Market Understanding", 
                    "Multilingual Support (Arabic & English)",
                    "24/7 Technical Assistance",
                    "Proven Track Record in UAE"
                  ].map((feature, index) => (
